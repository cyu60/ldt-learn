...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        default:
          "bg-white text-black bg-slate-200 hover:bg-slate-100 border-2 border-b-4 active:border-b-2",
        primary:
          "bg-primary text-primary-foreground hover:bg-primary/80 border-sky-500 border-b-4 active:border-b-0",
        ...
        super:
          "bg-gradient-to-r from-indigo-800 to-red-600 via-purple-600 via-blue-600 text-primary-foreground hover:bg-indigo-500/90 border-indigo-600 border-b-4 active:border-b-0",
